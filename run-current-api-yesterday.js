// Script to run current day API service for previous day (yesterday)
...
const main = async () => {
  try {
    console.log('[INFO] Running current day API service for YESTERDAY...');
    ...
    // Run the scraping service for yesterday using the date range directly (API category)
    ...
    console.log('[SUCCESS] Current day API service for YESTERDAY completed successfully');
    console.log('Result:', {
