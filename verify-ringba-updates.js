...
if (mismatches > 0) {
  console.log(`\nNote: Some values may not have propagated yet due to eventual consistency.`);
  console.log(`Check the events in Ringba UI to verify void events were created.`);
}
